                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="text-right">
                            <p className="text-xs opacity-75 uppercase">Live Balance</p>
                            <p className="text-xl font-bold tracking-tight">
                                {waste < 0 ? (
                                    <>ERROR: {waste.toLocaleString()} Pts</>
                                ) : waste === 0 && totalInput > 0 ? (
                                    <>✓ Perfect Efficiency</>
                                ) : (
                                    <>Waste: {waste.toLocaleString()} Pts</>
                                )}
                            </p>
                        </div>
                        ...
                        <Button
                            ...
                            disabled={!canSubmit}
                            className={`h-10 px-6 font-semibold shadow-sm ${canSubmit
            ...
            <div className="max-w-7xl mx-auto p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card className="flex flex-col h-[calc(100vh-180px)] border-slate-200 shadow-sm">
                        <CardHeader className="pb-3 border-b bg-slate-50/50">
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-lg font-semibold text-slate-800">Factory Output</CardTitle>
                                <Button onClick={addOutputRow} size="sm" className="bg-slate-900 hover:bg-slate-800 text-white">+ Add Product</Button>
                            </div>
                        </CardHeader>
